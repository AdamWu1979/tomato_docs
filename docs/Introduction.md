...
### What is T1
T1 is usually measured by acquiring a series of images after an inversion pulse, so called inversion times, as presented on the graph below. The recovery after an inversion pulse can be modeled with a following equation.
...
For more information see following online sources.
...
### What is T2
Usually measured with Spin Echo MRI sequences. A series of images with different echo times is acquired. The T2 recovery can be modeled with a following equation.
...
### What is T2star
Usually measured with Gradient MRI sequences. A series of images with different echo times is acquired. The T2 recovery can be modeled with a following equation.
